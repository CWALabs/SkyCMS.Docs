...
Follow the steps in this guide to add a new API endpoint, implementing the full feature stack from models and handlers through DI registration and controller wiring.
