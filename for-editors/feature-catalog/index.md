---
canonical_title: Editor Feature Catalog
description: Concrete entry point for SkyCMS editing and management tools with direct links to role-ready guides.
doc_type: Reference
product_area: editor
user_intent: find-concrete-feature-guides
audience:
  - Content Editors
  - Content Managers
difficulty: beginner
...
```mermaid
flowchart LR
  A[Editor Tasks] --> B[Content Editors]
