---
canonical_title: Content Editors
description: Concrete guide to SkyCMS content editors, including when to use each editor and where to find task guides.
doc_type: Explanation
product_area: editor
user_intent: choose-the-right-editor
audience:
  - Content Editors
  - Content Managers
difficulty: beginner
...
| Editor | Use it when you need to... | Best for |
| --- | --- | --- |
...
- [Choosing an editor (site builders)](../../for-site-builders/choosing-an-editor.md)
- [Editor workflow reference](../../for-editors/overview.md)
