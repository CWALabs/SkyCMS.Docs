---
canonical_title: Site Settings
description: Configure site-level settings in SkyCMS including static pages, CDN integration, and AI provider setup.
doc_type: How-to
product_area: administration
user_intent: configure-site-settings-cdn-and-ai
audience:
  - Administrators
difficulty: beginner
version: current
...
- configure core editor behavior (static pages, authentication requirements),
- set up a CDN provider for content delivery,
- configure the tenant AI provider.

Site settings are accessible to users with the **Administrator** role.
