---
canonical_title: Dashboard Overview (Pages Catalog)
description: Understand the SkyCMS Pages Catalog — your starting point for finding, creating, and managing all content pages.
doc_type: How-to
product_area: editor
user_intent: navigate-pages-catalog-find-and-manage-pages
audience:
  - Content Editors
  - Content Managers
  - Administrators
...
1. Type part of the page title or URL in the **Search** field.
2. The list filters live as you type.
3. Click the page row or an action icon to open it.

### Create a new page

1. Click **New Page**.
2. Fill in the title and choose a template.
3. Click **Create** to proceed to editing.

See [Creating Articles](creating-articles.md) for the full workflow.
...
3. Use the **More** menu → **Publish** or **Schedule** to change it.

See [Publish a Page](publish-a-page.md) for step-by-step publish instructions.
...
- [Creating Articles](creating-articles.md) — full page creation walkthrough
- [Publish a Page](publish-a-page.md) — publish, schedule, and unpublish
- [Version History](version-history.md) — browse and restore earlier saves
- [Article Permissions](article-permissions.md) — restrict who can view or edit a page
- [Trash and Recovery](trash-and-recovery.md) — recover deleted pages
