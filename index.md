---
canonical_title: SkyCMS Documentation Home
description: Start here to install, configure, build, and publish with SkyCMS — multi-tenant ASP.NET Core CMS for editors and developers.
doc_type: Explanation
product_area: documentation
user_intent: find-fastest-path-to-first-success
audience:
  - All
difficulty: beginner
version: current
...
```mermaid
flowchart LR
  Understand[Understand SkyCMS] --> Install[Install and configure]
  Install --> Build[Build first website pages]
  Build --> Publish[Publish and verify]
  Publish --> Operate[Operate and scale]
```
