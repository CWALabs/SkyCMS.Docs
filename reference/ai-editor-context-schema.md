...
Use the scripted smoke test checklist here:

- [AI Help Semantic Search Smoke Test](ai-help-semantic-search-smoke-test.md)

This runbook is intended for quick manual verification after changes to help-query ranking, embedding toggle behavior, or fallback logic.
