...
Blog posts are articles that belong to a blog stream. They use the same article editing pipeline (Visual Editor and Code Editor) but are organized and rendered through the blog infrastructure.
